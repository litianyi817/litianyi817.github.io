(function () {
  ...
  if (headerEl) fetch("/components/header.html?v=38").then(r => r.text()).then(h => headerEl.innerHTML = h);
  if (footerEl) fetch("/components/footer.html?v=38").then(r => r.text()).then(function (h) {
